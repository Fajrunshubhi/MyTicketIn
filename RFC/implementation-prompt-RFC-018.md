Petunjuk Implementasi untuk RFC-018: Refund, Chargeback, dan Dispute
...
Konteks
Implementasi ini mencakup RFC-018, yang berfokus pada menyediakan refund produksi, chargeback, dispute, evidence, serta alokasi dampaknya pada ledger dan payout. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-018.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-018.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
