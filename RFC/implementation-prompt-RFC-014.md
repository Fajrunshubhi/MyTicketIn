Petunjuk Implementasi untuk RFC-014: Hardening dan Release Gate
...
Konteks
Implementasi ini mencakup RFC-014, yang berfokus pada menyelesaikan error taxonomy, kompatibilitas, aksesibilitas, observability, backup, dan gerbang rilis. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-014.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-014.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
