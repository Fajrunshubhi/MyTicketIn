Petunjuk Implementasi untuk RFC-019: Production Security dan Fraud Prevention
...
Konteks
Implementasi ini mencakup RFC-019, yang berfokus pada mengeraskan autentikasi, pembayaran, fraud control, vulnerability management, dan incident response untuk produksi. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-019.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-019.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
