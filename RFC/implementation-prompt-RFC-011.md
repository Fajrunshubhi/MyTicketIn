Petunjuk Implementasi untuk RFC-011: Scanner dan Check-in
...
Konteks
Implementasi ini mencakup RFC-011, yang berfokus pada menyediakan scanner online, hasil validasi tegas, check-in atomik, dan log percobaan. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-011.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-011.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
