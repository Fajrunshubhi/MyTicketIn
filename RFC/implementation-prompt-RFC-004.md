Petunjuk Implementasi untuk RFC-004: Organizer dan Moderasi
...
Konteks
Implementasi ini mencakup RFC-004, yang berfokus pada menyediakan pengajuan profil organizer serta keputusan approve, reject, dan suspend oleh admin. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-004.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-004.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
