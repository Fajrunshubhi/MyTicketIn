Petunjuk Implementasi untuk RFC-006: Lifecycle Event dan Petugas
...
Konteks
Implementasi ini mencakup RFC-006, yang berfokus pada menyediakan moderasi, publikasi, pembatalan event, preview, stop-sale, dan penugasan petugas. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-006.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-006.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
