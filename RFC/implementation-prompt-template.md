Petunjuk Implementasi untuk RFC-[ID]: [Judul]
...
Konteks
Implementasi ini mencakup RFC-[ID], yang berfokus pada [deskripsi singkat]. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-[ID].md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-[ID].md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
