Petunjuk Implementasi untuk RFC-001: Platform dan Fondasi Data
...
Konteks
Implementasi ini mencakup RFC-001, yang berfokus pada menetapkan stack, migrasi database, konfigurasi lingkungan, struktur modular, dan fondasi kualitas proyek. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-001.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-001.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
