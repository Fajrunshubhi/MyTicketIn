Petunjuk Implementasi untuk RFC-020: Reliability, Support, dan Commercial Launch
...
Konteks
Implementasi ini mencakup RFC-020, yang berfokus pada menetapkan SLO, disaster recovery, dukungan operasional, progressive rollout, dan gerbang peluncuran komersial. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-020.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-020.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
