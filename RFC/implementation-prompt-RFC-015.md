Petunjuk Implementasi untuk RFC-015: Legal, Privasi, dan KYC/KYB
...
Konteks
Implementasi ini mencakup RFC-015, yang berfokus pada menetapkan fondasi legal, tata kelola privasi, hak subjek data, serta verifikasi organizer untuk kesiapan komersial. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-015.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-015.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
