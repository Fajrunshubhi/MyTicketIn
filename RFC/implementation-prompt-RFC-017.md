Petunjuk Implementasi untuk RFC-017: Settlement, Payout, dan Reconciliation
...
Konteks
Implementasi ini mencakup RFC-017, yang berfokus pada menyediakan perhitungan payable, settlement, payout organizer, hold, dan rekonsiliasi yang idempoten. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-017.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-017.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
