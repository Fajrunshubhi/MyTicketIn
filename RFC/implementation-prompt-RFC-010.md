Petunjuk Implementasi untuk RFC-010: E-ticket, QR, dan Wallet
...
Konteks
Implementasi ini mencakup RFC-010, yang berfokus pada menerbitkan tepat satu tiket per unit Paid, QR aman, dan wallet tiket pembeli. Silakan merujuk ke dokumen-dokumen berikut:
...
@RFC-010.md untuk persyaratan spesifik yang sedang diimplementasikan
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-010.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
