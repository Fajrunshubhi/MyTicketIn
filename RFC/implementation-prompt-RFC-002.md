Petunjuk Implementasi untuk RFC-002: Identitas, Sesi, dan RBAC
...
Konteks
Implementasi ini mencakup RFC-002, yang berfokus pada menyediakan registrasi, login, sesi aman, serta otorisasi berbasis peran dan kepemilikan. Silakan merujuk ke dokumen-dokumen berikut:
...
Batasan Lingkup
Harap hanya mengimplementasikan fitur yang ditentukan dalam @RFC-002.md. Jika Anda menemukan ketergantungan pada fitur dari RFC lain, catatlah tetapi jangan mengimplementasikannya kecuali jika diinstruksikan secara eksplisit.
